...
| `STORY_PROGRESS` | `0xDC08DC` | s16 story-progress counter advanced by field scripts (7th Heaven `PPV` var). Defined in ff7_addresses.h since early research; NOT yet consumed by any mod code â€” recorded for future story-aware features (e.g., suppressing story-locked exits). Was missing from this table entirely (2026-07-23 audit) |
