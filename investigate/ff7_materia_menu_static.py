#!/usr/bin/env python3
"""
ff7_materia_menu_static.py -- Statically map the MATERIA menu sub-screen
...
_log_path = os.path.join(
    ...
    f"materia_menu_static_{datetime.datetime.now():%Y%m%d_%H%M%S}.log"
)
...
MATERIA_SUB = 0x70CF0B     # menu_subs_call_table[3] (v2.31 table dump)
...
STR_VAS = {}
for label in ("Check", "Arrange", "Equips", "Ability list", "Equip effect",
              "To next level", "Trash", "Exchange", "AP"):
...
dump_disasm(MATERIA_SUB, SUB_LEN, "materia_menu_sub (table[3])")
